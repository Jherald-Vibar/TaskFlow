...
<div class="py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="w-full p-8 lg:w-1/2">
            ...
            <form method="POST" action="{{route('store')}}">
                ...
                <div class="mt-4">
                    ...
                    <input id="email" class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="name" name="name" value="{{ old('name') }}" required autofocus />
                </div>
        ...
        <div class="hidden lg:block lg:w-1/2 bg-cover"
            style="background-image:url('{{asset('images/register-image.png')}}')">
        </div>
    </div>
</div>
