...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-5 overflow-x-auto rounded-lg" id="task-list">
        ...
        <div class="flex justify-start mt-4">
            <button onclick="toggleModal('date')" class="flex items-center  gap-2 hover:from-red-600 hover:to-red-800 text-black font-semibold text-sm px-5 py-2.5 rounded shadow-md hover:shadow-lg transition">
    ...
    <form id="taskForm" action="{{ route('task.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="date" name="due_date" value="" id="dueDatess" class="w-full px-3 py-2 border rounded-lg bg-gray-50 text-sm" required>
            </div>
            <div>
...
window.onload = function() {
    const dueDate = getQueryParam('date');
    console.log(dueDate);
    if (dueDate) {
        document.getElementById('dueDatess').value = dueDate;
    }
};
</script>
</div>
