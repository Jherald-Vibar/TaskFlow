        ...
        <form class="mt-8 space-y-3" action="{{route('storeAccount', ['id' => $user->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 space-y-2">
                        <label class="text-sm font-bold text-gray-500 tracking-wide"></label>
                            <input class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="text" name="username" placeholder="Username">
                    </div>
                    <div class="grid grid-cols-1 space-y-2">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                                <div class="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                                    ...
                                    <img class="has-mask h-36 object-center" src="{{$user->image ?? asset('images/profile.png')}}" alt="freepik image">
                                    </div>
