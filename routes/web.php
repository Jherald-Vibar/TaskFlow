...
=======
    ...
    //PDF
    Route::get('/insights/download-pdf', [TaskController::class, 'downloadPdf'])->name('insights.downloadPdf');

    Route::get('/activity-log', [TaskController::class, 'showActivityLog'])->name('activity-log');
